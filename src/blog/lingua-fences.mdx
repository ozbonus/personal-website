...
* The rules for most games like this limit valid words to something you might find in a dictionary, but that's just the convention. Before you play, decide what constitutes a valid word. Maybe you'd like to include names of fictional characters or onomatopoeia.
