...
keywords: [
  ...
  "target game",
  "elimination game",
  "silly classroom game",
  "just for fun game",
  "classroom diversion",
  "elementary school game",
  "games with sticky balls",
  "games on the whiteboard",
  "games with targets",
  "games involving throwing",
  "games with a starting point",
  "games with student drawings",
  "creative classroom game",
  "imagination game",
  "lesson integration ideas",
  "describing predictions in games",
  "describing results in games",
  "slower paced game",
  "games with student faces as targets",
  "games with random starting points",
  "games with turns",
  "games with straight lines",
  "games with winners",
  "games with artistic elements",
  "games with themes",
  "games for language practice",
  "engaging classroom game",
  "interactive classroom game",
  "games for a break",
  "games that are not too educational",
  "games for pure enjoyment",
  "games with simple rules",
  "games that involve strategy",
  "games that involve a bit of luck"
]
---
...
<PostPicture src={typhoon1} alt="The faces of six students are drawn on the whiteboard along with a red X a little left of center." />

Draw a variety of students around the board and pick a place for the titular typhoon to start.

<PostPicture src={typhoon2} alt="A sticky ball has hit the upper right area." />

A student throws a sticky ball to where they want to typhoon to travel.

<PostPicture src={typhoon3} alt="A line is drawn from the starting point chose at the beginning of the game to the point where the ball landed, crossing one student's face. The sticky ball has now landed on the lower right." />
...
<PostPicture src={typhoon4} alt="The line from before is extended to the point where the sticky ball landed, crossing over two more faces." />
