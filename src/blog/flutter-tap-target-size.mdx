...
<Picture src={spacing} alt="An iOS app with padded buttons and a macOS app with un-padded buttons." />
...
<Picture src={shrinkwrap} alt="An app on both iOS and macOS with un-padded buttons." />
...
<Picture src={padded} alt="An app on both iOS and macOS with padded buttons." />
