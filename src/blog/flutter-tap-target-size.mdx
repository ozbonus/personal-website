...
![An iOS app with padded buttons and a macOS app with un-padded buttons.](../images/tap-target-spacing.webp)
...
![An app on both iOS and macOS with un-padded buttons.](../images/tap-target-spacing-shrinkwrap.webp)
...
![An app on both iOS and macOS with padded buttons.](../images/tap-target-spacing-padded.webp)
