...
keywords: [
  ...
  "group game",
  "large group game",
  "games with paper and whiteboard",
  "low cost game",
  "easy to learn game",
  "number grid game",
  "erasing game",
  "strategic game",
  "games for reviewing numbers",
  "games with downloadable materials",
  "games for different age groups",
  "games to increase engagement",
  "games that add skill to chance",
  "interactive bingo",
  "physical bingo",
  "target bingo"
]
...
<PostPicture src={bingo01} alt={"A 6 by 6 grid of random numbers between 1 and 36"} title="New game" />
...
<PostPicture src={bingo02} alt={"A bingo sheet with numbers between 1 and 36."} title="Fresh sheet" />
...
<PostPicture src={bingo03} alt={"A 6 by 6 grid of numbers from 1 to 36 written in random order being hit by a sticky ball."} title="First throw" />


⤷ A student throws a sticky ball at a number advantageous to them. Everyone who has that number on a sheet circles it.

<PostPicture src={bingo04} alt={"One number has been erased by a yellow eraser."} title="Eraser time" />

⤷ Erase the number that was hit.

<PostPicture src={bingo06} alt={"A line between the empty space and another number has been erased."} title="Expanding territory" />
...
<PostPicture src={bingo07} alt={"Many more numbers and lines have been erased."} title="Late game" />

⤷ The grid of numbers continues to morph as the game progresses.

<PostPicture src={bingo08} alt={"A bingo sheet with some numbers circled in red."} title="Bingo!" />
