...
![An image a 6 by 6 grid of numbers from 1 to 36 written in random order.](../images/sticky-bingo-rules-01.webp)
...
![An image of a bingo sheet.](../images/sticky-bingo-rules-02.webp)
...
![An image a 6 by 6 grid of numbers from 1 to 36 written in random order being hit by a sticky ball.](../images/sticky-bingo-rules-03.webp)

⤷ A student throws a sticky ball at a number advantageous to them. Everyone who has that number on a sheet circles it.

![An image a 6 by 6 grid of numbers from 1 to 36 written in random order, but on number has been erased by a yellow eraser.](../images/sticky-bingo-rules-04.webp)

⤷ Erase the number that was hit.

![An image a 6 by 6 grid of numbers from 1 to 36 written in random order, but on number has been erased by a yellow eraser and so has the diving line to another number.](../images/sticky-bingo-rules-06.webp)
...
![An image a 6 by 6 grid of numbers from 1 to 36 written in random order, but many numbers and lines have been erased.](../images/sticky-bingo-rules-07.webp)

⤷ The grid of numbers continues to morph as the game progresses.

![An image of a bingo sheet with some numbers circled in red.](../images/sticky-bingo-rules-08.webp)
