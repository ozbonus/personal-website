...
pubDate: 2024-05-14
author: "Chris Perry"
cover: "/src/images/animal-vegetable-title.webp"
...
![A Closeup image of the player controls.](/src/images/animal-vegetable-controller-closeup.webp)

These two buttons are all you need to play.

![An animated image of the player entering their age.](/src/images/animal-vegetable-age.gif)
...
![An animated image of the tutorial portion of the game.](/src/images/animal-vegetable-push-both.gif)
...
![An animated image of the player being warned to stop flailing at the buttons and slow down.](/src/images/animal-vegetable-slow.gif)

Play quickly, but carefully. If you just hit the buttons crazily, the game will stop until you slow down.

![An animated image of the button-mashing bonus game.](/src/images/animal-vegetable-mash.gif)
...
![An image of the five modes that the game cycles through: attract, age, tutorial, game, and score.](/src/images/animal-vegetable-mode-flow.webp)
...
![An image of a card from each of the three difficulty levels. The easy mode card is a picture of a cat. The medium mode card is a small picture of a banana next to the word "banana". The hard mode card is the word "rice" without a picture.](/src/images/animal-vegetable-card-difficulty.webp)
...
![A composite image of the controller wiring. Top: An overview of the wiring from an Arduino to four switches. Left: A closeup of a switch with spade connectors on C and NC. Right: A closeup of the wires connected to an Arduino's GND, \~13, 12, \~11, and \~10 IO headers](/src/images/animal-vegetable-hardware.webp)
