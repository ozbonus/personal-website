...
<Picture src={closeup} alt={"A closeup of the player controls."} />

These two buttons are all you need to play.

<Picture src={age} alt={"An animation of the player entering their age."} />
...
<Picture src={pushBoth} alt={"An animation of the tutorial mode."} />
...
<Picture src={slow} alt={"An animation of the player being warned to slow down."} />

Play quickly, but carefully. If you just hit the buttons crazily, the game will stop until you slow down.

<Picture src={mash} alt={"An animation of the button-mashing bonus game."} />
...
<Picture src={modeFlow} alt={"A diagram of mode transitions: attract, age, tutorial, game, and score."} />
...
<Picture src={difficulty} alt={"A sample from each of the three difficulty levels."} />
...
<Picture src={hardware} alt="Top: An overview of the wiring from an Arduino to four switches. Left: A closeup of a switch with spade connectors on C and NC. Right: A closeup of the wires connected to an Arduino's GND, \~13, 12, \~11, and \~10 IO headers" />
