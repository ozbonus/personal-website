...
keywords: [
  ...
  "games for athletic students",
  "simple game rules",
  "games with variations",
  "games using Wordwall",
  "speaking cards",
  "flip tiles",
  "games for large vocabulary sets",
  "games with a stopwatch",
  "games with a timer",
  "games with teams of unequal size",
  "games where students line up",
  "games where students say words",
  "games where the teacher erases",
  "games with a winning team",
  "exciting classroom game",
  "games that avoid boredom",
  "games that add excitement",
  "games that are good for review",
  "fun classroom game",
  "games with considerations",
  "games that use sticky balls",
  "games with whiteboard and markers",
  "easy to set up game",
  "games with visual targets",
  "games that involve speaking",
  "games that involve physical activity"
]
---

import PostPicture from "../components/PostPicture.astro"
import stickyDash0 from "../images/sticky-dash-0.gif";
import stickyDash1 from "../images/sticky-dash-1.gif";
import stickyDash2 from "../images/sticky-dash-2.gif";
import stickyDash3 from "../images/sticky-dash-3.gif";
import stickyDash4 from "../images/sticky-dash-4.gif";
...
<PostPicture src={stickyDash1} alt="A large drawing on a whiteboard of an apple and a pencil separated by a vertical line, each with three stars underneath." />
...
<PostPicture src={stickyDash2} alt="A sticky ball hits the pencil. The student who threw the sticky ball shouts, 'Pencil!'" />
...
<PostPicture src={stickyDash3} alt="One of the stars beneath the pencil is being erased." />
...
<PostPicture src={stickyDash4} alt="Only two stars remain below the pencil." />
