...
pubDate: 2024-04-10
author: "Chris Perry"
cover: "/src/images/sticky-dash-0.gif"
...
![An drawing of an apple and a banana separated by a vertical line, each with three stars underneath.](/src/images/sticky-dash-1.gif)
...
![A drawing of the pencil from the previous image being hit by a sticky ball. A word bubble pointing to the bottom edge reads, "Pencil!"](/src/images/sticky-dash-2.gif)
...
![A drawing of an eraser erasing on of the star beneath the pencil.](/src/images/sticky-dash-3.gif)
...
![There are now only two stars beneath the pencil.](/src/images/sticky-dash-4.gif)
