...
<Picture src={stickyDash1} alt="A large drawing on a whiteboard of an apple and a pencil separated by a vertical line, each with three stars underneath." />
...
<Picture src={stickyDash2} alt="A sticky ball hits the pencil. The student who threw the sticky ball shouts, 'Pencil!'" />
...
<Picture src={stickyDash3} alt="One of the stars beneath the pencil is being erased." />
...
<Picture src={stickyDash4} alt="Only two stars remain below the pencil." />
